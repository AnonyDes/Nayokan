...
export const metadata: Metadata = {
  ...
  description: "Your VTI application has been logged.",
...
const NEXT_STEPS = [
  ...
  { num: "02", title: "Review by the programme team", desc: "The relevant VTI programme lead will review your application against programme fit and cohort availability." },
...
export default async function ApplySuccess({ searchParams }: { searchParams: Promise<{ ref?: string }> }) {
    ...
    <section className="success-state" style={{ paddingTop: 180 }}>
      <div className="wrap" style={{ maxWidth: 720 }}>
        ...
        <h1 className="success-title">
          Application{" "}
          <em style={{ fontStyle: "italic", fontWeight: 500, color: "var(--green-deep)" }}>received.</em>
        </h1>
        <p className="success-lede">
          Thank you. Your application to the Nayokan Vocational Training Institute has been logged. A
          programme lead will be in touch within 5–10 business days.
        </p>
        <div className="success-ref">
          <span className="meta">Reference</span>
          <span>
            {ref ?? "NAY-2026-VTI-000000"} <Tbc>demo ref</Tbc>
          </span>
        </div>
        <div className="success-actions">
          <a href="/" className="btn btn-primary">
            Back to VTI <span className="arrow">→</span>
          </a>
